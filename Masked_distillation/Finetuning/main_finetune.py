...
from util.pos_embed import interpolate_pos_embed, interpolate_pos_embed2
from util.misc import NativeScalerWithGradNormCount as NativeScaler

import models_mamba as models_mamba
...
def get_args_parser():
    parser = argparse.ArgumentParser('ARM fine-tuning for image classification', add_help=False)
    ...
    parser.add_argument('--ft_scan', default='v2', type=str,
                        help='Name of scan manner to ft')
    ...
    parser.add_argument('--ssr', type=float, default=0.2, metavar='PCT',
                        help='Drop path rate (default: 0.1)')
...
def main(args):
    ...
    model = models_mamba.__dict__[args.model](
        bimamba_type=args.ft_scan,
        num_classes=args.nb_classes,
        shuffle_rate=args.ssr,
    ...
    if args.finetune and not args.eval:
        ...
        if args.ft_scan == 'v3':
            ...
            new_dict = checkpoint_model

        # interpolate position embedding
        new_dict = interpolate_pos_embed2(model, new_dict)
